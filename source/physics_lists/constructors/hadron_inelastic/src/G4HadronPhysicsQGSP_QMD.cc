...
// ********************************************************************
//
// $Id: G4HadronPhysicsQGSP_QMD.cc 93617 2015-10-27 09:00:41Z gcosmo $
//
//---------------------------------------------------------------------------
//
// ClassName:   G4HadronPhysicsQGSP_QMD
//
...
#include "G4HadronPhysicsQGSP_QMD.hh"
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(G4HadronPhysicsQGSP_QMD);

G4ThreadLocal G4HadronPhysicsQGSP_QMD::ThreadPrivate* 
G4HadronPhysicsQGSP_QMD::tpdata = 0;

G4HadronPhysicsQGSP_QMD::G4HadronPhysicsQGSP_QMD(G4int)
    :  G4VPhysicsConstructor("hInelastic QGSP_QMD")
/*  , theNeutrons(0)
    , theFTFPNeutron(0)
    , theQGSPNeutron(0)
    , theBinaryNeutron(0)
...
G4HadronPhysicsQGSP_QMD::G4HadronPhysicsQGSP_QMD(const G4String& name, G4bool /* quasiElastic */)
...
void G4HadronPhysicsQGSP_QMD::CreateModels()
{
...
G4HadronPhysicsQGSP_QMD::~G4HadronPhysicsQGSP_QMD() 
{
  if (!tpdata) return;
...
void G4HadronPhysicsQGSP_QMD::ConstructParticle()
{
...
void G4HadronPhysicsQGSP_QMD::ConstructProcess()
{
