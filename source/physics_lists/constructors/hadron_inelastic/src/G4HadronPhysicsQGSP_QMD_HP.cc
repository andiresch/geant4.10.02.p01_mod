...
// ********************************************************************
//
// $Id: G4HadronPhysicsQGSP_QMD_HP.cc 93878 2015-11-03 08:18:00Z gcosmo $
//
//---------------------------------------------------------------------------
//
// ClassName:   G4HadronPhysicsQGSP_QMD_HP
//
// Author: 2006 G.Folger
//
// Based on G4HadronPhysicsQGSP_QMD
//
// Modified:
...
#include "G4HadronPhysicsQGSP_QMD_HP.hh"
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(G4HadronPhysicsQGSP_QMD_HP);

G4ThreadLocal G4HadronPhysicsQGSP_QMD_HP::ThreadPrivate*
G4HadronPhysicsQGSP_QMD_HP::tpdata = 0;

G4HadronPhysicsQGSP_QMD_HP::G4HadronPhysicsQGSP_QMD_HP(G4int)
    :  G4VPhysicsConstructor("hInelastic QGSP_QMD_HP")
/*  , theNeutrons(0)
    , theFTFPNeutron(0)
    , theQGSPNeutron(0)
    , theBinaryNeutron(0)
...
G4HadronPhysicsQGSP_QMD_HP::G4HadronPhysicsQGSP_QMD_HP(const G4String& name, G4bool /* quasiElastic */)
...
void G4HadronPhysicsQGSP_QMD_HP::CreateModels()
{
  ...
  tpdata->theBinaryNeutron->SetMaxEnergy(maxQMD);
  ...
  tpdata->theBinaryPro->SetMaxEnergy(maxQMD);
...
G4HadronPhysicsQGSP_QMD_HP::~G4HadronPhysicsQGSP_QMD_HP() 
{
  if (!tpdata) return;
...
void G4HadronPhysicsQGSP_QMD_HP::ConstructParticle()
{
...
void G4HadronPhysicsQGSP_QMD_HP::ConstructProcess()
{
