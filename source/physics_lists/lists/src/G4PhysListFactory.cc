  ...
  : defName("FTFP_BERT"),verbose(1)
{
  ...
  G4String ss[23] = {
    ...
    "QGSP_BERT","QGSP_BERT_HP","QGSP_BIC","QGSP_BIC_HP","QGSP_QMD","QGSP_QMD_HP","QGSP_BIC_AllHP",
...
G4PhysListFactory::GetReferencePhysList(const G4String& name)
{
  ...
  else if(had_name == "QGSP_QMD")       {p = new QGSP_QMD(verbose);}
  else if(had_name == "QGSP_QMD_HP")    {p = new QGSP_QMD_HP(verbose);}
